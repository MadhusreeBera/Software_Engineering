...
public class UserBookDao {
    ...
    public void findByCriteria(PaginatedList<UserBookDto> paginatedList, UserBookCriteria criteria, SortCriteria sortCriteria) throws Exception {
        ...
        StringBuilder sb = new StringBuilder("select ub.UBK_ID_C c0, b.BOK_TITLE_C" +
                " c1, b.BOK_SUBTITLE_C c2, b.BOK_AUTHOR_C c3, b.BOK_GENRE_C c8, b" +
                ".BOK_LANGUAGE_C c4, b.BOK_PUBLISHDATE_D c5, ub.UBK_CREATEDATE_D c6, ub.UBK_READDATE_D c7");
...
//        parameterMap.put("userId", criteria.getUserId());
        ...
        for (Object[] o : l) {
            ...
            userBookDto.setGenres((String) o[i++]);
    ...
    public void findAll(PaginatedList<UserBookDto> paginatedList, SortCriteria sortCriteria) throws Exception {
        Map<String, Object> parameterMap = new HashMap<String, Object>();
//        List<String> criteriaList = new ArrayList<String>();
