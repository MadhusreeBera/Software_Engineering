...
public class UserDao {
    ...
    public String registerNewUser(User user) throws Exception {
        System.out.println("user: " + user.getUsername() + " email: " + user.getEmail() + " password: " + user.getPassword() + " theme: " + user.getTheme() + " locale: " + user.getLocaleId() + " firstConnection: " + user.isFirstConnection() + " id: " + user.getId() + " createDate: " + user.getCreateDate() + " deleteDate: " + user.getDeleteDate());
