...
public class Book {
     ...
     * Genre's.
     */
    @Column(name = "BOK_GENRE_C", nullable = false, length = 255)
    ...
    public Book(BookBuilder bookBuilder) {
        ...
        this.subtitle = bookBuilder.getSubtitle();
        this.author = bookBuilder.getAuthor();
        this.genres = bookBuilder.getGenres();
        this.description = bookBuilder.getDescription();
        this.isbn10 = bookBuilder.getIsbn10();
        this.isbn13 = bookBuilder.getIsbn13();
        this.pageCount = bookBuilder.getPageCount();
        this.language = bookBuilder.getLanguage();
        this.publishDate = bookBuilder.getPublishDate();
        // this.avg_rating = 0;
        // this.num_ratings = 0;
    }
