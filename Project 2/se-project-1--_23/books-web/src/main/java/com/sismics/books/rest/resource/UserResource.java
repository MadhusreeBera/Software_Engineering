...
import com.sismics.books.rest.builder.ConcreteUserBuilder;
import com.sismics.books.rest.builder.UserBuilder;
import com.sismics.books.rest.builder.UserDirector;
    ...
    public Response register(
        ...
        try {
            ...
            if ("AlreadyExistingUsername".equals(e.getMessage())) {
                ...
                throw new ServerException("AlreadyExistingEmail", "E-Mail already used", e);
            } else {
