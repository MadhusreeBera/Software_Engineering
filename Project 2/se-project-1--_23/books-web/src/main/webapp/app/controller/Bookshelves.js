 ...
 * Book controller.
 */
App.controller('Bookshelves', function($scope, $timeout, Restangular, $stateParams, $http, $location) {
  /**
  ...
  $scope.pageBooks = function(next) {
    ...
    $scope.loading = true;
    Restangular.one('book/listBookByTag').get({
      offset: $scope.offset,
      limit: $scope.limit,
  ...
  // Load tags
  Restangular.one('tag/getPublic').get().then(function(data) {
