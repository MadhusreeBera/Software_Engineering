...
.config(function($stateProvider, $httpProvider, RestangularProvider) {
  ...
  .state('library', {
    ...
    .state('bookshelves', {
      ...
      views: {
        'page': {
          templateUrl: 'partial/bookshelves.html',
  ...
  .state("itunecontroller", {
    url: "/itunes",
    views: {
      page: {
        templateUrl: "partial/itunes.add.html",
        controller: "ItunesController",
      },
    },
  })
  .state("spotifycontroller", {
    url: "/spotify",
    views: {
      page: {
        templateUrl: "partial/spotify.add.html",
